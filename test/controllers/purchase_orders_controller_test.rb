...
class PurchaseOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post purchase_orders_url, params: { purchase_order: { description: @purchase_order.description, photo: @purchase_order.photo, reception_date: @purchase_order.reception_date, shipping_date: @purchase_order.shipping_date, status: @purchase_order.status, user_id: @purchase_order.user_id } }
    end
  ...
  test "should update purchase_order" do
    patch purchase_order_url(@purchase_order), params: { purchase_order: { description: @purchase_order.description, photo: @purchase_order.photo, reception_date: @purchase_order.reception_date, shipping_date: @purchase_order.shipping_date, status: @purchase_order.status, user_id: @purchase_order.user_id } }
